...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Languages:}{ Python, C++, SQL, R} \\ \vspace{3pt}
...
\section{Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeItem{Implemented data parsers and contributed to an Azure-based ETL pipeline to support model training workflows.}
	    \resumeItem{Produced comprehensive documentation for machine learning models to ensure clarity and reproducibility and worked within Agile framework}
        \resumeItemListEnd
	\resumeSubheading
	{University Of Tuebingen}{Tuebingen, Germany}
{\textbf{Student Researcher}}{May 2024 - September 2024}
	\resumeItemListStart
	\resumeItem{Researched the effectiveness of soft label datasets in improving the calibration of deep neural networks, comparing their utility against regularization techniques such as MixUp, Manifold MixUp, CutMix, and Dropout in distance-aware networks like SNGP, DUQ, and Mahalanobis Distance. \href{https://github.com/sam-laing/soft_cifar}{Github Repository} of some work here
	\resumeItemListEnd
...
%        \resumeItemListEnd
    ...
    \resumeSubheading
      {Trinity College}{Dublin, Ireland}
{\textbf{Teaching Assistant}}{Sep 2021 \textbf{--} Dec 2021 and Sep 2022 - December 2022}
        \resumeItemListStart
	\resumeItem{Lead tutorials for the advanced Engineering Mathematics course offerred at Trinity College Dublin. The topics included Fourier Analysis, Partial Differential Equations and Linear Programming.}
        \resumeItemListEnd
%	\resumeSubheading
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      ...
      {MSc. in Machine Learning;   \textbf{Current Grade Average: 1.4 (equivalent 3.8 GPA USA)}}{Oct 2022 \textbf{--} Present}
...
%        \small{\item{
	...
	Conducting research into adaptive optimizers for transformer foundation models. In particular, interested in second-order optimization, LLM pretraining and fast training. Supervised by \href{http://orvi.altervista.org/}{Antonio Orvieto}}}
	\resumeItemListEnd
        \resumeSubHeadingListStart
    \resumeEducationHeading
...
\section{Awards \& Achievements}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{Trinity College Academic Gold Medal:}{Awarded to graduating students who achieved over a certain grade point average througout the four year degree.} \\ \vspace{3pt}
