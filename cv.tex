...
{\textbf{Research Engineer}}{Sep 2025 \textbf{--} Present}
	...
	\resumeItem{Particularly interested in understanding the Muon optimizer and its contemporaries in contrast to more popular adaptive methods}
        \resumeItemListEnd
...
%        \small{\item{
	...
	Researched adaptive and second-order optimizers (in particular, Muon) for transformer-based language models. In particular, was interested in pretraining efficiency and understanding training dynamics. Supervised by \href{http://orvi.altervista.org/}{Dr. Antonio Orvieto}}}
	\resumeItemListEnd
        \resumeSubHeadingListStart
    \resumeEducationHeading
    {Trinity College Dublin}
      ...
      \small{\textbf{\href{https://github.com/sam-laing/bachelor-thesis/blob/main/diss.pdf}{Bachelor Thesis}:} Applied category theoretical techniques (in particular simplicial homotopy theory) to prove several fundamental theorems of algebraic topology. Supervised by \href{https://www.maths.tcd.ie/people/kellyj/}{Dr Jack Kelly} }
  \resumeSubHeadingListEnd
