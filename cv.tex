...
\section{Skills}
  ...
  \resumeSubHeadingListStart
	...
	\textbf{Techniques:}{CNNs, RNNs, Transformers, XGBoost , Random Forrest Models, Hypothesis Testing, GLMs, Gaussian Processes, Markov Chains, Deep Q-learning, Imitation Learning,   }
...
\section{References}
  \vspace{2pt}
  \resumeSubHeadingListStart
    \item{Susan Spence (SoftCo founder) , }
   \resumeSubHeadingListEnd
