...
\resumeItem{In particular investigated their utility in comparison to using regularization techniques like MixUp, Manifold Mixup, CutMix and Dropout along with distance aware networks like SNGP, DUQ and Mahalanobis Distance.}
